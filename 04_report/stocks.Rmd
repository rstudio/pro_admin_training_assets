---
title: "Report for `r params$symbol` on `r Sys.Date()`"
output:
  html_document:
    code_folding: hide
    toc: yes
...
highchart() %>% 
  ...
  hc_add_series(type = "ohlc", prices, yAxis=0, name= params$symbol) %>% 
  hc_add_series(type = "xts", prices[,paste0(params$symbol,".Volume")], 
